...
현재 구성에서는 1 kHz, 2 kHz뿐 아니라 5 kHz, 10 kHz 수준까지도 동작시켜 테스트할 수 있습니다. Arduino Uno의 SPI는 8 MHz로 동작하고 74HC595 기반 7-segment 모듈도 이 정도 갱신 속도는 충분히 처리할 수 있기 때문에, 실제 한계는 디스플레이 자체보다는 Arduino 코드 처리시간과 타이머 설정 정밀도에 더 크게 영향을 받습니다. 따라서 10 kHz까지는 고속 카메라나 이벤트 카메라의 시간 응답을 확인하기 위한 실험 범위로 사용할 수 있습니다.
